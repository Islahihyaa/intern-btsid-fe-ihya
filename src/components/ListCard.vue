<template>
  ...
  <!-- <div v-for="list in $state.lists" :key="list.listId">
    {{ list }}
  </div> -->
  <!-- <div v-for="list in list.lists" :key="list.listId">
    {{ list.lists }}
  </div> -->
  <!-- <pre>
    <div v-for="board in $state.boards" :key="board.boardId">
      {{ board.lists }}
    </div>
  </pre> -->
  <div class="list-card">
...
$state.lists = listComputed.lists
...
const getListData = async () => {
  try {
    ...
    const response = await getList(accessToken);
